...
../qt6-source/configure -prefix $PWD/qt-static-install -static -release -opensource -confirm-license -submodules qtbase,qtnetwork,qttools,qttranslations -nomake tests -nomake examples -skip qt3d -skip qtmultimedia -platform win32-g++ -openssl-linked
